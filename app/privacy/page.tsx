  ...
  return (
    <Section rule={false} className="pt-[clamp(130px,15vh,190px)]">
      ...
      <div className="mt-8 max-w-[74ch] space-y-4 text-[0.96rem] text-muted">
        ...
        <p>Only what you send us. When you submit the contact form, the name, email address, company and message you typed are delivered straight to our inbox through a form service. This website keeps no database of its own and stores nothing about you. We do not run trackers that build a profile of you across other websites, and this site sets no advertising cookies.</p>
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>Contact form submissions are passed through a third-party form provider, which delivers them to us by email and retains them only in transit.</li>
