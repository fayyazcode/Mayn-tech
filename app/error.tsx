    ...
    <section className="flex min-h-[70vh] items-center py-[clamp(130px,15vh,190px)]">
      <div className="shell">
        <div className="grid items-start gap-[clamp(28px,5vw,84px)] lg:grid-cols-2">
          ...
          <div>
            <p className="max-w-[44ch] text-[clamp(1rem,1.1vw,1.08rem)] text-steel">
            ...
            <div className="mt-7 flex flex-wrap gap-3.5">
              <button
                onClick={reset}
                className="inline-flex items-center justify-center rounded-full border border-transparent bg-bright px-7 py-3.5 text-[0.95rem] font-medium text-void transition-colors hover:bg-silver"
              >
                Try again
              </button>
